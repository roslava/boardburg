...
{{--breadcrumb  --}}
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{$skateFromBase['name'] ?? '0'}}</li>
        </ol>
    </nav>
    ...
    <h4>Цена: {{$skateFromBase['price'] ?? '0'}} руб.</h4>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 p-0 p-lg-5 p-md-4 p-sm-3">
                <div class="shadow bg-white rounded p-3  p-2" style="display: flex; justify-content: center;box-sizing: border-box; width: 100%">
                    <row  style="display: flex; align-items: center; padding: 0;  margin:0;">

                        <img class="img-fluid max-width: 100% height: auto" src="{{$skateFromBase['img'] ?? '0'}}" style="max-height: 400px;" alt="">
                ...
                <div class="card-technical rounded bg-light mt-4 mb-4 p-2 shadow"
                    ...
                    <div>ID: {{$skateFromBase->id}} / Внешний ID: {{$skateFromBase['externsl_id'] ?? 'нет'}}</div>
...
{{--Удалить и редактировать--}}
            <div class="col-lg-4 col-md-12 col-sm-12 p-lg-5 p-md-4 p-sm-3" style="padding-top: 0!important; display: flex; align-items: end; justify-content: end">
                ...
                <a href="{{ route('skates_base.edit', $skateFromBase->id)}}" class="btn btn-edit" style="margin-right: 0.6rem">
