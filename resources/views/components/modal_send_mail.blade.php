            ...
            <div class="modal-content">
                <div class="modal-header"
                    ...
                    <div style="width: fit-content; padding: 0; margin-left: 10px ">
                        <i style="font-size: 1.4rem; cursor: pointer" id="modal_cl_btn"
                           class="bi bi-x-square modal__close-btn"
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contact.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name_modal_send_mail" name="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email_modal_send_mail" name="email"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  @error('message') is-invalid @enderror" id="message_modal_send_mail" name="message"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('captcha') is-invalid @enderror"
                                   placeholder="Введите, пожалуйста, три символа" id="captcha_modal_send_mail" name="captcha">
                            @error('captcha')
                            <span
                                class="invalid-feedback"
                                role="alert">
